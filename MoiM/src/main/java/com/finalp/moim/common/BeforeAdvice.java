...
public class BeforeAdvice {
	//목적: 로그 출력용 메소드를 사용해서 aop를 구동 테스트 해 봄
	...
	//1.pointcut설정용 메소드 작성 : 내용이 없어야함
	@Pointcut("execution(* com.test.firstspring..*.*(..))")
	...
	public void beforeLog(JoinPoint jp) {
		...
		logger.info("[메소드 실행전 확인] : " + methodName + "() 메소드 매개변수 갯수 : " + args.length);
